...
-- Tipos de custos fixos (sem vínculo com eventos)
...
COMMENT ON TABLE tipo_custos_fixos IS 'Tipos/categorias de custos fixos (sem vínculo com eventos)';
COMMENT ON TABLE custos_fixos IS 'Custos fixos do usuário (sem vínculo com eventos)';
COMMENT ON TABLE anexos_custo_fixo IS 'Anexos de custos fixos';
